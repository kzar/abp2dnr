...
ChromeRules.prototype =
{
  ...
  processFilter(filter)
  {
    ...
    {
      // Only RE2 compatible regular expressions are supported. We need to skip
      // filter which use unsupported filteres. Short of including the entire
      // RE2 engine, we'll just perform some simplistic checks.
      // FIXME - In the future we should definitely be more thorough.
      // See https://github.com/google/re2/wiki/Syntax
      if (filter.regexp.source.includes("(?"))
        return false;
    }
