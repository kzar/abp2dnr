...
const {RegExpFilter, ContentFilter,
       WhitelistFilter} = require("../node_modules/adblockpluscore/lib/filterClasses");
const rewriteResources = require("../node_modules/adblockpluscore/data/resources");
...
function generateRule(filterDetails, id, specificOnlyDomains)
{
  ...
  if (filter.rewrite)
  {
    ...
    if (!rewriteResources.hasOwnProperty(rewrite))
      return;
